...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +62 895 3852 60156</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i>Tokopekita22@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
            ...
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                ...
                <?php if (isset($_SESSION['CUSID'] )) { ?>  
                  ...
                  <li><a   href="<?php echo web_root?>logout.php"><i class="fa fa-lock"></i> Keluar</a></li>
                <?php }else{ ?> 
                <li><a data-target="#smyModal" data-toggle="modal"  href=""><i class="fa fa-lock"></i> Masuk</a></li>
              <?php } ?>
              </ul>
            </div>
          </div>
    ...
    <div class="footer-widget">
      <div class="container">
        <p>Anda dapat mengubah bagian ini menggunakan informasi pribadi Anda sendiri</p>
        <div class="row">
          <div class="col-sm-3">
